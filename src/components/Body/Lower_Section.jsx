  ...
  return (
    ...
    >
      <div className="md:w-[80%] m-auto w-[95%]">
        <div
          className="bg-[#F8F8FF] md:flex h-[290px] p-12 mt-8  hover:shadow-2xl "
          style={{
        ...
        >
          <div className="md:w-1/2 w-full ">
            <div className="text-[24px] text-[#222939] font-bold">
          ...
          <div className="md:w-1/2 w-full ">
            <img src={person} alt="" className="relative top-[-120px]" />
          </div>
        </div>
        <div
          className="bg-[#F8F8FF] md:flex h-[290px] p-12 mt-36  hover:shadow-2xl "
          style={{
            backgroundImage: `url(${wave})`,
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
        ...
        >
          <div className="md:w-1/2 w-full ">
            <img src={women} alt="" className="relative top-[-120px]" />
          </div>
          <div className="md:w-1/2 w-full ">
            <div className="text-[24px]   text-[#222939] font-bold">
